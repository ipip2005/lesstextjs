...
function normalizeOptions(options) {
    ...
    return __assign({ flexibleElement: options.monitorElement, lineHeight: lineHeight, linesCount: 2, omission: '...', omissionBreakLastWord: true, reserveExtraSpace: false, separator: '' }, options);
}
